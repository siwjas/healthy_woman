...
if defined?(Api::V1::ApplicationController)
  class Api::V1::Articles::ArticlesController < Api::V1::ApplicationController
    ...
    # GET /api/v1/articles/articles/:id
    def show
    end
    ...
    # PATCH/PUT /api/v1/articles/articles/:id
    def update
    ...
    # DELETE /api/v1/articles/articles/:id
    def destroy
      @article.destroy
    end
    ...
    module StrongParameters
      ...
      def article_params
        strong_params = params.require(:articles_article).permit(
          *permitted_fields,
          :title,
          :content,
          :published,
  ...
  class Api::V1::Articles::ArticlesController
  end
end
